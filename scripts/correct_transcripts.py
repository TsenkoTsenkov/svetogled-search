...
LITERAL_REPLACEMENTS = [
    ...
    # --- Episode-specific: monastic / Boris / Ottoman / vero-uchenie ---
    ("мунашество", "монашество"),
    ("мунашески", "монашески"),
    ("мунашеско", "монашеско"),
    ("мунашеска", "монашеска"),
    ("мунашеските", "монашеските"),
    ("мунашеството", "монашеството"),
    ("мунашеския", "монашеския"),
    ("Мунашески", "Монашески"),
    ("Мунашеско", "Монашеско"),
    ("Мунашество", "Монашество"),
    (" мунах ", " монах "),
    ...
    (" мунаси ", " монаси "),
    (" мунасите ", " монасите "),
    ("до-мунашески", "до-монашески"),
    ("домунашески", "домонашески"),
    ("златотарсачи", "златотърсачи"),
    ("златотарсач", "златотърсач"),
    ("приработват", "преработват"),
    ("приработва", "преработва"),
    ("приминям", "премина"),
    ("крайна деня", "края на деня"),
    ("осмислят целият", "осмислят целия"),
    ("невидяние", "невиждания"),
    ("Безбог", "Без Бог"),
    ("потършим", "потърсим"),
    ("тълбини", "дълбини"),
    ("висени и до тези тълбини", "висини и до тези дълбини"),
    ("висени и до тези дълбини", "висини и до тези дълбини"),
    ("всеки дневно", "всекидневно"),
    ("Обикто", "Обикновено"),
    ("обикто", "обикновено"),
    ("Обектуенно", "Обикновено"),
    ("обектуенно", "обикновено"),
    ("Оправляваше", "Управляваше"),
    ("оправляваше", "управляваше"),
    ("Оправлявал", "Управлявал"),
    ("оправлявал", "управлявал"),
    ("Самодържица", "Самодържец"),
    ("самодържица", "самодържец"),
    ("Сети Борис", "Свети Борис"),
    ("сети Борис", "Свети Борис"),
    ("Кирали методи", "Кирил и Методий"),
    ("Кирали и Методи", "Кирил и Методий"),
    ("На ум Климент и Ангелари", "Наум, Климент и Ангеларий"),
    ("ум Климент и Ангелари", "Наум, Климент и Ангеларий"),
    ("Ангелари", "Ангеларий"),
    ("на свет си", "на светци"),
    ("Давя му условия", "Дава им условия"),
    ("Владимир Расате", "Владимир-Расате"),
    ("слепява", "ослепява"),
    ("Слепява", "Ослепява"),
    ("констатанираме", "констатираме"),
    ("константираме", "констатираме"),
    ("константира", "констатира"),
    ("константирал", "констатирал"),
    ("пръвославно", "православно"),
    ("пръвославен", "православен"),
    ("пръвославна", "православна"),
    ("пръвославни", "православни"),
    ("Пръвославно", "Православно"),
    ("Пръвославен", "Православен"),
    ("Пръвославна", "Православна"),
    ("Пръвославни", "Православни"),
    ("господсващо", "господстващо"),
    ("господсваща", "господстваща"),
    ("създадаха", "създадоха"),
    ("по-отделно", "поотделно"),
    ("9 септемля", "9 септември"),
    ("септемля", "септември"),
    ("виднъж", "веднъж"),
    ("Виднъж", "Веднъж"),
    ("замонаш", "замонаши"),
    ("На 1 ноември 1922 година парламента", "На 1 ноември 1922 година парламентът"),
    ("36-я турски султан", "36-ият турски султан"),
    ("последния турски султан, Мехмед VI, напуска", "последният турски султан, Мехмед VI, напуска"),
    ("Мехмед VI", "Мехмед VI"),
    ("В наприливи и отливи", "на приливи и отливи"),
    ("наприливи и отливи", "на приливи и отливи"),
    ("Във какво се състои", "В какво се състои"),
    ("въпроса с въвеждането", "въпросът с въвеждането"),
    ("въпроса се повдига", "въпросът се повдига"),
    ("въпроса, в какво", "въпросът, в какво"),
    ("потърпевши сме всички", "потърпевши сме всички"),
    ("този въпрос се повдига от време на време, наприливи и отливи", "този въпрос се повдига от време на време, на приливи и отливи"),
